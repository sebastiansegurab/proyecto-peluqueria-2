...
public class CitaServiceImpl implements CitaService {
	...
	public ByteArrayInputStream exportAllData() throws Exception {
		...
		String[] columns = { "#", "Codigo", "Servicio", "Asistidor por", "Fecha", "Hora", "Duracion", "Nombre Cliente",
				"Total" };
	...
	@Override
	public List<Cita> noPagadas(Long cod_u) throws Exception {
		return citarepository.noPagadas(cod_u);
	}
